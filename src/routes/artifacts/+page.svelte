<svelte:head><title>Artifacts | DrokBot</title></svelte:head>
...
<section class="space-y-5">
	...
	{:else if artifacts.length === 0}
		<div class="rounded-3xl border border-base-300 bg-base-100 p-8 text-center">
			...
			<p class="mt-1 text-sm text-base-content/50">Artifacts are created when DrokBot generates code, documents, images, or other content in chat.</p>
		</div>
	{:else}
